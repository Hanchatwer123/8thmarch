  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0b0424] via-[#100820] to-[#06111b] text-white overflow-hidden relative">
      ...
      <header className="pt-28 pb-8 px-6 max-w-4xl mx-auto text-center z-20 relative">
        ...
        >
          A cosmic wish for a magical heroine.
        </motion.p>
      </header>
      ...
      <section className="px-6 max-w-4xl mx-auto py-6 z-20">
        <div className="rounded-xl border border-white/8 overflow-hidden bg-gradient-to-br from-[#081229]/50 p-4">
      ...
      <section className="px-6 max-w-3xl mx-auto py-12 z-30">
        <div className="bg-gradient-to-br from-[#06102a]/40 to-[#0b0520]/40 border border-white/8 rounded-2xl p-6 text-center">
          <h3 className="text-xl font-medium mb-3">Make a Wish</h3>
          <p className="text-sm text-violet-200/60 mb-6">Press the Wish button — destiny will sparkle.</p>
            ...
            <AnimatePresence>
              {result && (
                ...
                >
                  ...
                  <p className="text-sm text-violet-200/70">May your path be as brilliant and rare as this wish.</p>
                </motion.div>
              )}
            </AnimatePresence>
          </div>
