...
const Aizere: React.FC = () => {
    ...
    const moodMessages = {
        queen: "Продолжай также править этим миром и сердцами других людей. Ты достойна всего мира!",
        ...
        diamond: "Ты невероятная, ведь для меня ты как 1 из 10 миллиарда людей на Земле. Ты уникальна и идеальна, прямо как алмаз"
    };

    const cards = [
        { text: "Who wants that perfect love story any way, anyway?" },
        { text: "OHH I LOVE YOU SO. BUT WHY I LOVE YOU, I'LL NEVER KNOW" },
        { text: "I invite you to stop this love drought that we both have" },
        { text: "Спасибо тебе за твою улыбку, тепло и то что ты делаешь мою жизнь лучше" },
        { text: "Спасибо что ты есть, за все те совместные моменты в нашем общении. Ты грациозна!" },
        { text: "Желаю тебе счастья, здоровья и чтобы никто и никогда не стирал улыбку с твоего лица. Я действительно хочу чтобы тебе было хорошо и чтобы ты всегда ходила радостная и веселая, потому что негоже такой королеве ходить грустной" }
    ];
                        ...
                        >
                            ...
                            <div className="space-y-8 text-xl md:text-3xl text-gray-200 font-light leading-relaxed">
                                ...
                                <p className="italic text-gray-400 text-lg md:text-xl pt-12">
                                    С праздником, любимая Айз, целую.
                                </p>
                            </div>
                        </motion.div>
                    </motion.div>
