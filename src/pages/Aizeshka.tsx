...
const Aizere: React.FC = () => {
    ...
    const moodMessages = {
        queen: "Продолжай также править этим миром и моим сердцем. Я уверен ты сводишь свой гарем с ума",
        ...
        diamond: "Ты идеальная и невероятная. Для меня ты как 1 из 10 миллиарда людей на Земле. Спасибо огромное"
    };
    ...
    const cards = [
        ...
        { text: "Спасибо что ты есть, за все те совместные моменты в нашем общении" },
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="space-y-8 text-xl md:text-3xl text-gray-200 font-light leading-relaxed">
                                ...
                                <p>
                                    Спасибо, что являешься той, кем ты по настоящему являешься. Я благодарен тебе за это. 
